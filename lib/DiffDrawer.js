...
class DiffDrawer {
  ...
  filterBy(filterArray)
  {
    ...
    var filteredSrcMarkers = _.filter(this.srcMarkersSorted, function(o) { return filterArray.includes(o.type); });
    var filteredDstMarkers = _.filter(this.dstMarkersSorted, function(o) { return filterArray.includes(o.type); });
