...
class DiffDrawer {
  ...
  //markers are now full, sort them
	var dstMarkersSorted = __WEBPACK_IMPORTED_MODULE_4_lodash___default()(dstMarkers).chain()
          .sortBy('id')
          .sortBy('position')
          .reverse()
          .value();

	var srcMarkersSorted = __WEBPACK_IMPORTED_MODULE_4_lodash___default()(srcMarkers).chain()
          .sortBy('id')
          .sortBy('position')
          .reverse()
          .value();
